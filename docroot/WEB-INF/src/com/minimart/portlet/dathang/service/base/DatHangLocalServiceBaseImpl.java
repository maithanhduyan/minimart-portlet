...
import com.minimart.portlet.dathang.service.DatHangLocalService;
...
/**
 * Provides the base implementation for the dat hang local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.minimart.portlet.dathang.service.impl.DatHangLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class DatHangLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DatHangLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.minimart.portlet.dathang.service.DatHangLocalServiceUtil} to access the dat hang local service.
	 */
	...
	@Override
	public DatHang addDatHang(DatHang datHang) throws SystemException {
		datHang.setNew(true);

		return datHangPersistence.update(datHang);
	}
	 ...
	 */
	@Override
	public DatHang createDatHang(long datHangId) {
		return datHangPersistence.create(datHangId);
	}
	...
	@Override
	public DatHang deleteDatHang(long datHangId)
		throws PortalException, SystemException {
		return datHangPersistence.remove(datHangId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DatHang deleteDatHang(DatHang datHang) throws SystemException {
		return datHangPersistence.remove(datHang);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DatHang.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return datHangPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return datHangPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return datHangPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return datHangPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return datHangPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public DatHang fetchDatHang(long datHangId) throws SystemException {
		return datHangPersistence.fetchByPrimaryKey(datHangId);
	}
	 ...
	 */
	@Override
	public DatHang getDatHang(long datHangId)
		throws PortalException, SystemException {
		return datHangPersistence.findByPrimaryKey(datHangId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return datHangPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DatHang> getDatHangs(int start, int end)
		throws SystemException {
		return datHangPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDatHangsCount() throws SystemException {
		return datHangPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DatHang updateDatHang(DatHang datHang) throws SystemException {
		return datHangPersistence.update(datHang);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.minimart.portlet.dathang.model.DatHang",
			datHangLocalService);
	}
	...
	private DatHangLocalServiceClpInvoker _clpInvoker = new DatHangLocalServiceClpInvoker();
}