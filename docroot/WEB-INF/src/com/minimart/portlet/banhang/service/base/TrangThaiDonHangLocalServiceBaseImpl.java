...
import com.minimart.portlet.banhang.service.TrangThaiDonHangLocalService;
...
/**
 * Provides the base implementation for the trang thai don hang local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.minimart.portlet.banhang.service.impl.TrangThaiDonHangLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TrangThaiDonHangLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrangThaiDonHangLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.minimart.portlet.banhang.service.TrangThaiDonHangLocalServiceUtil} to access the trang thai don hang local service.
	 */
	...
	@Override
	public TrangThaiDonHang addTrangThaiDonHang(
		TrangThaiDonHang trangThaiDonHang) throws SystemException {
		trangThaiDonHang.setNew(true);

		return trangThaiDonHangPersistence.update(trangThaiDonHang);
	}
	 ...
	 */
	@Override
	public TrangThaiDonHang createTrangThaiDonHang(long trangThaiDonHangId) {
		return trangThaiDonHangPersistence.create(trangThaiDonHangId);
	}
	...
	@Override
	public TrangThaiDonHang deleteTrangThaiDonHang(long trangThaiDonHangId)
		throws PortalException, SystemException {
		return trangThaiDonHangPersistence.remove(trangThaiDonHangId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrangThaiDonHang deleteTrangThaiDonHang(
		TrangThaiDonHang trangThaiDonHang) throws SystemException {
		return trangThaiDonHangPersistence.remove(trangThaiDonHang);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TrangThaiDonHang.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trangThaiDonHangPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trangThaiDonHangPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TrangThaiDonHang fetchTrangThaiDonHang(long trangThaiDonHangId)
		throws SystemException {
		return trangThaiDonHangPersistence.fetchByPrimaryKey(trangThaiDonHangId);
	}
	 ...
	 */
	@Override
	public TrangThaiDonHang getTrangThaiDonHang(long trangThaiDonHangId)
		throws PortalException, SystemException {
		return trangThaiDonHangPersistence.findByPrimaryKey(trangThaiDonHangId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trangThaiDonHangPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrangThaiDonHang> getTrangThaiDonHangs(int start, int end)
		throws SystemException {
		return trangThaiDonHangPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTrangThaiDonHangsCount() throws SystemException {
		return trangThaiDonHangPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrangThaiDonHang updateTrangThaiDonHang(
		TrangThaiDonHang trangThaiDonHang) throws SystemException {
		return trangThaiDonHangPersistence.update(trangThaiDonHang);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.minimart.portlet.banhang.model.TrangThaiDonHang",
			trangThaiDonHangLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trangThaiDonHangPersistence.getDataSource();
	...
	private TrangThaiDonHangLocalServiceClpInvoker _clpInvoker = new TrangThaiDonHangLocalServiceClpInvoker();
}