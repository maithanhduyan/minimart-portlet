 ...
 * @generated
 */
public abstract class DonHangChiTietActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DonHangChiTietActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DonHangChiTietLocalServiceUtil.getService());
		setClass(DonHangChiTiet.class);

		setClassLoader(com.minimart.portlet.banhang.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("donHangChiTietId");
	}
}