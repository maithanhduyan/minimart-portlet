...
/**
 * Provides the local service interface for DonHang. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see DonHangLocalServiceUtil
...
public interface DonHangLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DonHangLocalServiceUtil} to access the don hang local service. Add custom service methods to {@link com.minimart.portlet.banhang.service.impl.DonHangLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
