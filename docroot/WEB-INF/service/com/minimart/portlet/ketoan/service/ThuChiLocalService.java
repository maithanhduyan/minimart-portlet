...
/**
 * Provides the local service interface for ThuChi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see ThuChiLocalServiceUtil
...
public interface ThuChiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ThuChiLocalServiceUtil} to access the thu chi local service. Add custom service methods to {@link com.minimart.portlet.ketoan.service.impl.ThuChiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
