 ...
 * @generated
 */
public abstract class BangLuongActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BangLuongActionableDynamicQuery() throws SystemException {
		setBaseLocalService(BangLuongLocalServiceUtil.getService());
		setClass(BangLuong.class);

		setClassLoader(com.minimart.portlet.ketoan.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("banLuongId");
	}
}