...
/**
 * Provides the local service interface for DatHangChiTiet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see DatHangChiTietLocalServiceUtil
...
public interface DatHangChiTietLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DatHangChiTietLocalServiceUtil} to access the dat hang chi tiet local service. Add custom service methods to {@link com.minimart.portlet.dathang.service.impl.DatHangChiTietLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
