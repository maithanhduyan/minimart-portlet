...
/**
 * Provides the local service interface for DatHang. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see DatHangLocalServiceUtil
...
public interface DatHangLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DatHangLocalServiceUtil} to access the dat hang local service. Add custom service methods to {@link com.minimart.portlet.dathang.service.impl.DatHangLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
