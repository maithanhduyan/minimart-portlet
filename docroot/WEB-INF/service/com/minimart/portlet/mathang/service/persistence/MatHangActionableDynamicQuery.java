 ...
 * @generated
 */
public abstract class MatHangActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MatHangActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MatHangLocalServiceUtil.getService());
		setClass(MatHang.class);

		setClassLoader(com.minimart.portlet.mathang.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("matHangId");
	}
}