...
/**
 * Provides the local service interface for NhomMatHang. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see NhomMatHangLocalServiceUtil
...
public interface NhomMatHangLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NhomMatHangLocalServiceUtil} to access the nhom mat hang local service. Add custom service methods to {@link com.minimart.portlet.mathang.service.impl.NhomMatHangLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
