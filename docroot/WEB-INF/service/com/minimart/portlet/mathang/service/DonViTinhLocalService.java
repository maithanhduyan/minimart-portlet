...
/**
 * Provides the local service interface for DonViTinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see DonViTinhLocalServiceUtil
...
public interface DonViTinhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DonViTinhLocalServiceUtil} to access the don vi tinh local service. Add custom service methods to {@link com.minimart.portlet.mathang.service.impl.DonViTinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
