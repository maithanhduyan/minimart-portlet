...
/**
 * Provides the local service interface for NhaCungCap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see NhaCungCapLocalServiceUtil
...
public interface NhaCungCapLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NhaCungCapLocalServiceUtil} to access the nha cung cap local service. Add custom service methods to {@link com.minimart.portlet.nhacungcap.service.impl.NhaCungCapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
