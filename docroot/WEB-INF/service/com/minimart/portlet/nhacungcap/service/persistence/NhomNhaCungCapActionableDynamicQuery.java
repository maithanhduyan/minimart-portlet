 ...
 * @generated
 */
public abstract class NhomNhaCungCapActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public NhomNhaCungCapActionableDynamicQuery() throws SystemException {
		setBaseLocalService(NhomNhaCungCapLocalServiceUtil.getService());
		setClass(NhomNhaCungCap.class);

		setClassLoader(com.minimart.portlet.nhacungcap.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("nhomNhaCungCapId");
	}
}