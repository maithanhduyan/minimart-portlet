...
/**
 * Provides the local service interface for NhomNhaCungCap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see NhomNhaCungCapLocalServiceUtil
...
public interface NhomNhaCungCapLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NhomNhaCungCapLocalServiceUtil} to access the nhom nha cung cap local service. Add custom service methods to {@link com.minimart.portlet.nhacungcap.service.impl.NhomNhaCungCapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
