 ...
 * @generated
 */
public abstract class DotKhuyenMaiChiTietActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DotKhuyenMaiChiTietActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(DotKhuyenMaiChiTietLocalServiceUtil.getService());
		setClass(DotKhuyenMaiChiTiet.class);

		setClassLoader(com.minimart.portlet.khuyenmai.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("dotKhuyenMaiChiTietId");
	}
}