...
/**
 * Provides the local service interface for DotKhuyenMai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see DotKhuyenMaiLocalServiceUtil
...
public interface DotKhuyenMaiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DotKhuyenMaiLocalServiceUtil} to access the dot khuyen mai local service. Add custom service methods to {@link com.minimart.portlet.khuyenmai.service.impl.DotKhuyenMaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
