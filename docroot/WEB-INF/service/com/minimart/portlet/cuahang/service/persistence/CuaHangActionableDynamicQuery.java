 ...
 * @generated
 */
public abstract class CuaHangActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CuaHangActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CuaHangLocalServiceUtil.getService());
		setClass(CuaHang.class);

		setClassLoader(com.minimart.portlet.cuahang.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("cuaHangId");
	}
}