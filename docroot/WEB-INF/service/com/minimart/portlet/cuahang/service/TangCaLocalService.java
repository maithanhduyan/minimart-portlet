...
/**
 * Provides the local service interface for TangCa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see TangCaLocalServiceUtil
...
public interface TangCaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TangCaLocalServiceUtil} to access the tang ca local service. Add custom service methods to {@link com.minimart.portlet.cuahang.service.impl.TangCaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
