...
/**
 * Provides the local service interface for NhomKhachHang. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see NhomKhachHangLocalServiceUtil
...
public interface NhomKhachHangLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NhomKhachHangLocalServiceUtil} to access the nhom khach hang local service. Add custom service methods to {@link com.minimart.portlet.khachhang.service.impl.NhomKhachHangLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
