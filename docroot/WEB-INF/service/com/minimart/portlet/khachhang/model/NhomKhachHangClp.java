 ...
 */
public class NhomKhachHangClp extends BaseModelImpl<NhomKhachHang>
	implements NhomKhachHang {
	public NhomKhachHangClp() {
	}
	...
	public void setNhomKhachHangId(long nhomKhachHangId) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				Class<?> clazz = _nhomKhachHangRemoteModel.getClass();

				Method method = clazz.getMethod("setNhomKhachHangId", long.class);

				method.invoke(_nhomKhachHangRemoteModel, nhomKhachHangId);
			}
			catch (Exception e) {
	...
	public void setCompanyId(long companyId) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTen(String ten) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, ten);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setHoatDong(boolean hoatDong) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, hoatDong);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDiemTichLuy(int diemTichLuy) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, diemTichLuy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTiLeGiamGia(int tiLeGiamGia) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, tiLeGiamGia);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUuTien(int uuTien) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, uuTien);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setImage(String image) {
		...
		if (_nhomKhachHangRemoteModel != null) {
			try {
				...
				method.invoke(_nhomKhachHangRemoteModel, image);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getNhomKhachHangRemoteModel() {
		return _nhomKhachHangRemoteModel;
	}

	public void setNhomKhachHangRemoteModel(
		BaseModel<?> nhomKhachHangRemoteModel) {
		_nhomKhachHangRemoteModel = nhomKhachHangRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _nhomKhachHangRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_nhomKhachHangRemoteModel,
	...
	public NhomKhachHang toEscapedModel() {
		return (NhomKhachHang)ProxyUtil.newProxyInstance(NhomKhachHang.class.getClassLoader(),
			new Class[] { NhomKhachHang.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		NhomKhachHangClp clone = new NhomKhachHangClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NhomKhachHangClp)) {
			return false;
		}

		NhomKhachHangClp nhomKhachHang = (NhomKhachHangClp)obj;
	...
	private BaseModel<?> _nhomKhachHangRemoteModel;
