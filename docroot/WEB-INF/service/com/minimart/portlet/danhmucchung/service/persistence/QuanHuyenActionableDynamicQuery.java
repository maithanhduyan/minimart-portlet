 ...
 * @generated
 */
public abstract class QuanHuyenActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public QuanHuyenActionableDynamicQuery() throws SystemException {
		setBaseLocalService(QuanHuyenLocalServiceUtil.getService());
		setClass(QuanHuyen.class);

		setClassLoader(com.minimart.portlet.danhmucchung.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("quanHuyenId");
	}
}