 ...
 * @generated
 */
public abstract class PhuongXaActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PhuongXaActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PhuongXaLocalServiceUtil.getService());
		setClass(PhuongXa.class);

		setClassLoader(com.minimart.portlet.danhmucchung.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("phuongXaId");
	}
}