...
/**
 * Provides the local service interface for QuanHuyen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see QuanHuyenLocalServiceUtil
...
public interface QuanHuyenLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuanHuyenLocalServiceUtil} to access the quan huyen local service. Add custom service methods to {@link com.minimart.portlet.danhmucchung.service.impl.QuanHuyenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
