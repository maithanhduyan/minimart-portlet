...
/**
 * Provides the local service interface for PhuongXa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see PhuongXaLocalServiceUtil
...
public interface PhuongXaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhuongXaLocalServiceUtil} to access the phuong xa local service. Add custom service methods to {@link com.minimart.portlet.danhmucchung.service.impl.PhuongXaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
