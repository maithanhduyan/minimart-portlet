...
/**
 * Provides the local service interface for Duong. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mai Thành Duy An
 * @see DuongLocalServiceUtil
...
public interface DuongLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DuongLocalServiceUtil} to access the duong local service. Add custom service methods to {@link com.minimart.portlet.danhmucchung.service.impl.DuongLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
